...
<section class="container max-w-2xl mx-auto px-6 py-10 md:py-12">
    <div class="flex flex-col-reverse mb-10 items-center justify-center lg:mb-24">
        <div class="mt-8">

            <h2 id="intro-powered-by-jigsaw" class="font-light mt-4">{{ $page->siteDescription }}</h2>

            <p class="text-lg text-center">Content can be boring, let's make it fun!<br class="hidden sm:block">Try it out Below:</p>

            <div class="flex my-10 items-center justify-center">
                <a href="/docs/getting-started" title="{{ $page->siteName }} getting started" class="bg-black hover:bg-black-dark font-normal text-white hover:text-white rounded mr-4 py-2 px-6">View on Github</a>

                <a href="https://jigsaw.tighten.co" title="Jigsaw by Tighten" class="bg-grey-light hover:bg-grey-dark text-blue-darkest font-normal hover:text-white rounded py-2 px-6">View Documentation</a>
            </div>
        </div>
    </div>
